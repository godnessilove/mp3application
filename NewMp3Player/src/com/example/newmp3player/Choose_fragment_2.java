...
@SuppressLint("NewApi")
public class Choose_fragment_2 extends ListFragment{
	...
	public void onResume() {
		Log.i("Choose_fragment_2", "Choose_fragment_2 onResume");
		if (handler == null) {
			handler = new Handler();
		}
		// 展示歌曲列表供选择
	...
	class button1chick implements OnClickListener {
		...
		public void onClick(View v) {
			...
			Choose_fragment_2.this.getActivity().finish();
		}
	}
	...
	public void onStop() {
		super.onStop();
		Log.i("Choose_fragment_2", "Choose_fragment_2 onStop");
		if (cursor != null && !cursor.isClosed()) {
			cursor.close();
			Log.i("Choose_fragment_2", "Choose_fragment_2 cursor 关闭");
		}
	}
